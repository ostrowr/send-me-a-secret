...
func validate(githubUsername string, privateKeyPassword string) error {
	client := githubapi.GetGithubClient("")
	utils.PrintDefault("Validating send-me-a-secret\n")

	utils.PrintDefault("Fetching public key from GitHub...\n")
	...
	utils.PrintCyan("Public key successfully fetched\n\n")
	utils.PrintDefault("Encrypting a test message using that public key\n")
	...
	utils.PrintCyan("Message successfully encrypted\n\n")
	utils.PrintDefault("Decrypting the test message using your private key\n")
	...
	utils.PrintCyan("Message successfully decrypted\n\n")
	utils.PrintGreen("Validation succeeded! You're good to go.\n")
	return nil
}
